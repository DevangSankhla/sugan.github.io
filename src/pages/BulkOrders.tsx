    ...
    <div className="min-h-screen bg-sugan-bone pt-20">
      ...
      <div className="bg-sugan-ink py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-sugan-bone/70 font-body mt-2">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <div className="bg-white rounded-2xl p-6 text-center shadow-sm">
            ...
            <h3 className="font-display text-lg text-sugan-ink mb-2">Corporate Gifting</h3>
          ...
          <div className="bg-white rounded-2xl p-6 text-center shadow-sm">
            ...
            <h3 className="font-display text-lg text-sugan-ink mb-2">Hotel & Restaurant Supplies</h3>
            <p className="text-sugan-ink/60 font-body text-sm">
          ...
          <div className="bg-white rounded-2xl p-6 text-center shadow-sm">
            ...
            <h3 className="font-display text-lg text-sugan-ink mb-2">Wholesale Partnership</h3>
            <p className="text-sugan-ink/60 font-body text-sm">
          ...
          <div className="bg-white rounded-2xl p-6 text-center shadow-sm">
            ...
            <h3 className="font-display text-lg text-sugan-ink mb-2">Big Project Finishing</h3>
            <p className="text-sugan-ink/60 font-body text-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Why Choose Us */}
          <div>
            <h2 className="font-display text-2xl text-sugan-ink mb-6">Why Choose Sugan for Bulk/Trade Orders?</h2>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-body font-medium text-sugan-ink">Volume Discounts</h3>
                  <p className="text-sugan-ink/60 font-body text-sm">Special pricing for orders above 50, 100, or 500+ units</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-sugan-gold rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h3 className="font-body font-medium text-sugan-ink">Custom Branding</h3>
                  <p className="text-sugan-ink/60 font-body text-sm">Logo engraving and custom packaging available</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-sugan-gold rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h3 className="font-body font-medium text-sugan-ink">Dedicated Support</h3>
                  <p className="text-sugan-ink/60 font-body text-sm">Personal account manager for all bulk inquiries</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-sugan-gold rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h3 className="font-body font-medium text-sugan-ink">Flexible Payment</h3>
                  <p className="text-sugan-ink/60 font-body text-sm">Credit terms available for verified businesses</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-sugan-ink text-sugan-bone rounded-2xl p-6">
              ...
              <p className="text-sugan-bone/60 font-body text-sm mt-4">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm">
            <h2 className="font-display text-2xl text-sugan-ink mb-6">Request a Quote</h2>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <label htmlFor="company" className="block font-body text-sm text-sugan-ink mb-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label htmlFor="phone" className="block font-body text-sm text-sugan-ink mb-2">
                      Phone Number *
                    </label>
                    <input
                      type="tel"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="orderType" className="block font-body text-sm text-sugan-ink mb-2">
                      Order Type *
                    </label>
                    <select
                      id="orderType"
                  ...
                  <div>
                    <label htmlFor="quantity" className="block font-body text-sm text-sugan-ink mb-2">
                      Estimated Quantity *
                    </label>
                    <select
                      id="quantity"
