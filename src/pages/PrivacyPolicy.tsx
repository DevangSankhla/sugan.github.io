    ...
    <div className="min-h-screen bg-sugan-bone pt-20">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
          ...
          <p className="text-sm text-sugan-ink/50 font-body">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
          <h2 className="font-display text-xl text-sugan-ink mb-4 flex items-center gap-2">
            <FileText className="w-6 h-6 text-sugan-gold" />
            Information We Collect
          </h2>
          <div className="space-y-4 font-body text-sugan-ink/70">
            <div>
              <h3 className="font-medium text-sugan-ink mb-2">Personal Information</h3>
            ...
            <div>
              <h3 className="font-medium text-sugan-ink mb-2">Non-Personal Information</h3>
              <ul className="space-y-2 ml-4">
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 bg-sugan-gold rounded-full mt-2"></span>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
          ...
          <p className="text-sugan-ink/70 font-body leading-relaxed mb-4">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
          <h2 className="font-display text-xl text-sugan-ink mb-4">Third-Party Services</h2>
          <p className="text-sugan-ink/70 font-body leading-relaxed mb-4">
          ...
          <p className="text-sugan-ink/70 font-body mt-4">
        ...
        {/* Your Rights */}
        <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
          <h2 className="font-display text-xl text-sugan-ink mb-4">Your Rights</h2>
          <p className="text-sugan-ink/70 font-body leading-relaxed mb-4">
        ...
        {/* Cookies */}
        <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
          <h2 className="font-display text-xl text-sugan-ink mb-4">Cookies</h2>
        ...
        <div className="bg-sugan-ink text-sugan-bone rounded-2xl p-8">
          ...
          <p className="text-sugan-bone/80 font-body mb-4">
