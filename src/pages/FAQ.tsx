...
const faqCategories: { [key: string]: FAQItem[] } = {
  ...
  'Returns & Refunds': [
    ...
    },
    {
      ...
      answer: 'Yes, a return processing fee is deducted from your refund amount for all returns: ₹100 for orders under ₹2,999, or 10% of the order total for orders ₹2,999 and above. This fee covers inspection, restocking, and handling costs.'
    },
    {
