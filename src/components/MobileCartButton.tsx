...
export default function MobileCartButton() {
  ...
  return (
    <button
      ...
      className="md:hidden fixed bottom-4 right-4 z-40 w-14 h-14 bg-sugan-ink rounded-full shadow-lg flex items-center justify-center"
      aria-label="Open cart"
    >
      <ShoppingCart className="w-6 h-6 text-sugan-bone" />
      {totalItems > 0 && (
