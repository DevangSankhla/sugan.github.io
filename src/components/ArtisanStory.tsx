  ...
  return (
    <div className="bg-sugan-brown text-sugan-cream rounded-2xl p-6">
      ...
      <div className="flex items-start gap-4 mb-4">
        <div className="w-16 h-16 bg-sugan-cream/10 rounded-full flex items-center justify-center flex-shrink-0">
          <User className="w-8 h-8 text-sugan-gold" />
        </div>
        <div>
          <h4 className="font-body font-medium text-lg">{displayArtisan}</h4>
          <div className="flex items-center gap-2 text-sugan-cream/60 text-sm mt-1">
      ...
      <p className="text-sugan-cream/80 font-body text-sm leading-relaxed mb-4">
        {displayStory}
      </p>

      <div className="flex items-center gap-4 pt-4 border-t border-sugan-cream/10">
        <div className="flex items-center gap-2">
          <Award className="w-5 h-5 text-sugan-gold" />
          <span className="text-sm font-body text-sugan-cream/80">25+ Years Experience</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-2 h-2 bg-sugan-gold rounded-full" />
          <span className="text-sm font-body text-sugan-cream/80">Handcrafted</span>
        </div>
      </div>
    </div>
  );
