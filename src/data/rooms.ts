...
export const roomProducts: Record<string, Product[]> = {
  pet: [
    ...
    {
      id: 'SAC040L',
      name: 'Acacia Wood Pet Feeder Stand with Stainless Steel Bowls, Large',
      price: 2399,
      originalPrice: 3399,
    ...
    {
      id: 'SAC040S',
      name: 'Acacia Wood Pet Feeder Stand with Stainless Steel Bowls, Small',
      price: 1999,
      originalPrice: 3399,
    ...
    {
      id: 'SAC041S',
      name: 'Acacia Wood Double-Bowl Pet Feeder, X-Leg Stand, Small',
      price: 1599,
      originalPrice: 3399,
    ...
    {
      id: 'SAC048L',
      name: 'Marble-Top Mango Wood Pet Feeder with Stainless Steel Bowls, Large',
      price: 2999,
      originalPrice: 3999,
    ...
    {
      id: 'SAC048M',
      name: 'Marble-Top Mango Wood Pet Feeder with Stainless Steel Bowls, Medium',
      price: 2499,
      originalPrice: 3999,
    ...
    {
      id: 'SAC048S',
      name: 'Marble-Top Mango Wood Pet Feeder with Stainless Steel Bowls, Small',
      price: 1999,
      originalPrice: 3999,
    ...
    {
      id: 'SAC08XS',
      name: 'Acacia Wood Stripe Cat Feeder with Stainless Steel Bowls, Extra Small',
      price: 799,
      originalPrice: 899,
    ...
    {
      id: 'SAC08_L',
      name: 'Acacia Wood Stripe Crate Pet Feeder with Stainless Steel Bowls, Large - 61x30x33 cm',
      price: 2399,
      originalPrice: 2999,
    ...
    {
      id: 'SAC08_M',
      name: 'Acacia Wood Stripe Crate Pet Feeder with Stainless Steel Bowls, Medium - 53x27x29 cm',
      price: 2099,
      originalPrice: 2899,
    ...
    {
      id: 'SAC08_S',
      name: 'Acacia Wood Stripe Crate Pet Feeder with Stainless Steel Bowls, Small - 46x23x18 cm',
      price: 1799,
      originalPrice: 1999,
    ...
    {
      id: 'SAC09XS',
      name: 'Acacia Wood Cat Feeder with S-Leg Stand and Stainless Steel Bowls, Extra Small',
      price: 799,
      originalPrice: 899,
    ...
    {
      id: 'SAC09_L',
      name: 'Acacia Wood Stripe Crate Pet Feeder, S-Leg Stand with Stainless Steel Bowls, Large',
      price: 1799,
      originalPrice: 2299,
    ...
    {
      id: 'SAC09_M',
      name: 'Acacia Wood Stripe Crate Pet Feeder, S-Leg Stand with Stainless Steel Bowls, Medium',
      price: 1399,
      originalPrice: 3999,
    ...
    {
      id: 'SAC09_S',
      name: 'Acacia Wood Stripe Crate Pet Feeder, S-Leg Stand with Stainless Steel Bowls, Small',
      price: 899,
      originalPrice: 1999,
    ...
    {
      id: 'TS-YFCT-J4WR',
      name: 'Acacia Wood Stripe Crate Pet Feeder with Stainless Steel Bowls, Medium',
      price: 1999,
      originalPrice: 3999,
    ...
    {
      id: 'ZF-S7K4-NAVG',
      name: 'Acacia Wood Double-Bowl Pet Feeder with Iron Stand, Large',
      price: 2499,
      originalPrice: 2999,
  ...
  kitchen: [
    ...
    {
      id: 'SAC04_L',
      name: 'Acacia Wood Rectangle Serving Tray, Natural Finish, Large',
      price: 1199,
      originalPrice: 1499,
    ...
    {
      id: 'SAC04_M',
      name: 'Acacia Wood Rectangle Serving Tray, Natural Finish, Medium',
      price: 1099,
      originalPrice: 1399,
    ...
    {
      id: 'SAC04_S',
      name: 'Acacia Wood Rectangle Serving Tray, Natural Finish, Small',
      price: 999,
      originalPrice: 999,
    ...
    {
      id: 'SAC05_L',
      name: 'Acacia Wood Hand-Carved Round Serving Bowl, Natural Grain, Large',
      price: 1199,
      originalPrice: 1999,
    ...
    {
      id: 'SAC05_M',
      name: 'Acacia Wood Hand-Carved Round Serving Bowl, Natural Grain, Medium',
      price: 1099,
      originalPrice: 1299,
    ...
    {
      id: 'SAC05_S',
      name: 'Acacia Wood Hand-Carved Round Serving Bowl, Natural Grain, Small',
      price: 799,
      originalPrice: 1099,
    ...
    {
      id: 'SAC07_L',
      name: 'Acacia Wood Stripe Crate Tray, White, Large',
      price: 1099,
      originalPrice: 1999,
    ...
    {
      id: 'SAC07_M',
      name: 'Acacia Wood Stripe Crate Tray, White, Medium',
      price: 899,
      originalPrice: 1499,
    ...
    {
      id: 'SAC07_S',
      name: 'Acacia Wood Stripe Crate Tray, White, Small',
      price: 599,
      originalPrice: 999,
